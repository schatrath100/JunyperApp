...
-- FROM pg_policies 
-- WHERE tablename IN ('plaidAccount', 'connected_banks');

-- Test the sync function (replace with actual values)
-- SELECT sync_plaid_account_data(
--     'your-connected-bank-id'::UUID,
--     'your-user-id'::UUID,
--     'test-plaid-account-id',
--     'test-item-id',
--     'Test Account',
--     'Test Official Name',
--     'depository',
