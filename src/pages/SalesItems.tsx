...
const SalesItems: React.FC = () => {
  ...
  const { sortedItems: sortedItems, sortConfig, requestSort } = useTableSort(
    items,
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead onClick={() => requestSort('Item_Number')} className="cursor-pointer hover:text-gray-900 dark:hover:text-gray-100">
                  Number
                </TableHead>
